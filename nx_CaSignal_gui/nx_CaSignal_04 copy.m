function varargout = nx_CaSignal_04(varargin)
% NX_CASIGNAL_04 M-file for nx_CaSignal_04.fig
%      NX_CASIGNAL_04, by itself, creates a new NX_CASIGNAL_04 or raises the existing
%      singleton*.
%
%      H = NX_CASIGNAL_04 returns the handle to a new NX_CASIGNAL_04 or the handle to
%      the existing singleton*.
%
%      NX_CASIGNAL_04('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NX_CASIGNAL_04.M with the given input arguments.
%
%      NX_CASIGNAL_04('Property','Value',...) creates a new NX_CASIGNAL_04 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before nx_CaSignal_04_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to nx_CaSignal_04_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help nx_CaSignal_04

% Last Modified by GUIDE v2.5 11-Jan-2011 17:19:41
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @nx_CaSignal_04_OpeningFcn, ...
                   'gui_OutputFcn',  @nx_CaSignal_04_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before nx_CaSignal_04 is made visible.
function nx_CaSignal_04_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for nx_CaSignal_04
...
% UIWAIT makes nx_CaSignal_04 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = nx_CaSignal_04_OutputFcn(hObject, eventdata, handles) 
