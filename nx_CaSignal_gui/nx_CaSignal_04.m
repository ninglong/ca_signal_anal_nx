...
% Last Modified by GUIDE v2.5 11-Apr-2011 11:09:44
...
if CaSignal.CaTrials_INIT == 1
   CaSignal.CaTrials = []; % ROIinfo = {};
    ...
    getROIinfoButton_Callback(handles.getROIinfoButton, eventdata, handles);
end
...
delete(h); finish_drawing = 1;
case 'Re-draw'
delete(h);
h = feval(draw); finish_drawing = 0;
case 'Cancel',
delete(h); finish_drawing = 1;
end
end
...
if length(CaSignal.ROIinfo)>= TrialNo_load && TrialNo_load > 0
    CaSignal.ROIinfo(TrialNo) = CaSignal.ROIinfo(TrialNo_load);
